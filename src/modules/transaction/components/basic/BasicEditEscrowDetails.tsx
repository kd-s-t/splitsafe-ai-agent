...
export default function BasicEditEscrowDetails({
  transaction,
  onCancel,
  onEdit,
  isLoading = false
}: EditEscrowDetailsProps) {
  console.log('🔍 BasicEditEscrowDetails Debug:', {
  ...
  return (
    <div className="container !rounded-2xl !p-6">
      ...
      {(() => {
        ...
        console.log('🔍 Basic Button Container Condition Debug:', {
        ...
        >
          {(() => {
            ...
            console.log('🔍 Basic Edit Button Condition Debug:', {
              hasRecipientAction,
              hasOnEdit: !!onEdit,
